...
В данном разделе приведен пример вычисления метрик качества бинарной классификации на основе [набора данных](/Practice/datasets/data_banknote_authentication.txt) обнаружения мошеннических транзакций:
